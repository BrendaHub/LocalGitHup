...
public class Jzs {
    ...
    private String jcgyhwz;

    private String qttsqk;
    ...
    public Jzs(Long id, Long hzid, String hzname, String zlname, String qsgx, String jtcy, String gms, String jcgyhwz, String qttsqk, String temp1, String temp2, String temp3, String temp4, String temp5, String qs, String sg, String ccsj, String mzsj) {
        this.id = id;
        this.hzid = hzid;
        this.hzname = hzname;
        this.zlname = zlname;
    ...
    public void setQsgx(String qsgx) {
        this.qsgx = qsgx == null ? null : qsgx.trim();
    }
    ...
    public String getJcgyhwz() {
        return jcgyhwz;
    }

    public void setJcgyhwz(String jcgyhwz) {
        this.jcgyhwz = jcgyhwz == null ? null : jcgyhwz.trim();
    }

    public String getQttsqk() {
        return qttsqk;
    }

    public void setQttsqk(String qttsqk) {
        this.qttsqk = qttsqk == null ? null : qttsqk.trim();
    }
