...
public class Sfzs {
    ...
    public Sfzs(Long id, Long ksid, String ksname, String title, String content, Long tzdate, Long hzid, String hzname, Long ysid, String ysname, String temp1, String temp2, String temp3, String temp4, String temp5) {
        this.id = id;
        this.ksid = ksid;
        this.ksname = ksname;
        this.title = title;
