...
public class Gms {
    ...
    public Gms(Long ID, Long HZID, String HZNAME, String GMWZMC, String FY, String CD, String BZHMS, String TEMP1, String TEMP2, String TEMP3, String TEMP4, String TEMP5) {
        this.ID = ID;
        this.HZID = HZID;
        this.HZNAME = HZNAME;
        this.GMWZMC = GMWZMC;
