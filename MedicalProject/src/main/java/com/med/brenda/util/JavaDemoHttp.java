...
public class JavaDemoHttp {
	public static void main(String[] args) throws UnsupportedEncodingException{
		...
		String strReg = "101100-WEB-HUAX-082478";   //注册号（由华兴软通提供）
        String strPwd = "YTIAKBRB";                 //密码（由华兴软通提供）
        String strSourceAdd = "";                   //子通道号，可为空（预留参数一般为空）
        String strTim = null;//HttpSend.paraTo16("2012-2-16 12:00:00"); //定时发送时间
        String strPhone = "13552666934";//手机号码，多个手机号用半角逗号分开，最多1000个
        String strContent = HttpSend.paraTo16("欢迎使用随访系统用户名为aaa密码BBB点击下载用户端http://www.baidu.com"+ (new Date()).toString());       //短信内容
